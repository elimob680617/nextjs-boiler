...
const Colors: React.FC = () => {
  ...
  return (
    <div className="flex flex-wrap items-center justify-center p-4" lang="en">
      {Object.entries(colors).map(([name, color]) => (
        <div
          key={name}
          className={`${color} w-69 h-60 flex flex-col items-center justify-center m-1 uppercase  rounded-xl shadow`}
        >
